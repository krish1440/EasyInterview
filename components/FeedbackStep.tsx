...
interface FeedbackStepProps {
  /** The configuration and profile of the candidate */
  userDetails: UserDetails;
  /** The sequential history of the interview session */
  transcript: Message[];
  /** Callback function to reset the application state and start a new session */
  onRestart: () => void;
}
...
const FeedbackStep: React.FC<FeedbackStepProps> = ({ userDetails, transcript, onRestart }) => {
  ...
  /**
   * Effect hook to trigger report generation upon component mount.
   * Also manages the persistence of interview history in localStorage.
   */
  useEffect(() => {
  ...
  /**
   * Custom tick renderer for the Radar chart to handle label wrapping and styling.
   * @param {any} props - Recharts tick properties.
   */
  ...
  /**
   * Maps numerical scores to CSS color and background utility classes.
